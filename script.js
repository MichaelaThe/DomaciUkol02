...
if(kusy < 50) {
    ...
    document.body.innerHTML = `<p> Konečná cena je: ${celkovaCena} </p>`
} else if(kusy >= 50 && kusy < 200) {
     const celkovaCena2 = kusy * 250
     document.body.innerHTML = `<p> Konečná cena je: ${celkovaCena2} </p>`
} else if(kusy >= 200 && kusy < 500) {
    const celkovaCena3 = kusy * 200
    document.body.innerHTML = `<p> Konečná cena je: ${celkovaCena3} </p>`
} else if(kusy >= 500 && kusy < 1000) {
    const celkovaCena4 = kusy * 150
    document.body.innerHTML = `<p> Konečná cena je: ${celkovaCena4} </p>` 
} else if(kusy >= 1000) {
    const celkovaCena5 = kusy * 120
    document.body.innerHTML = `<p> Konečná cena je: ${celkovaCena5} </p>`
} 